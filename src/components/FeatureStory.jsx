...
const features = [
  ...
  },
  {
    ...
    copy: "Stream from a cloud provider for realtime speed and top accuracy, or download a model and transcribe fully on-device — hold send to keep a single dictation local. Same keyboard, two honest routes.",
  ...
  },
  {
    ...
    copy: "Long pauses are trimmed and long dictations get paragraphs automatically. Make a selection formal, concise, translated, or summarized with the model you pick — plus community prompts, custom actions, and snippets.",
    tag: "AI rewriting · your model",
    visual: "reword",
  },
  {
    icon: ArrowsClockwise,
    label: "04 — ANY KEYBOARD",
    title: "Add voice without giving up your keyboard.",
    copy: "Dictate registers as a system-wide voice input, so the mic key in other keyboards and apps transcribes through Dictate — your provider, your models. Or keep the optional floating button: four skins, drag it anywhere, and hold it for a freeform voice command.",
    tag: "System voice input · floating mic",
    visual: "floating",
  },
  {
    icon: Watch,
