  ...
  return (
    <div className="install-box">
      <div className="install-panel-heading">
        ...
        <div>
          ...
          <p>
            ...
            updates. There is no monthly subscription: offline models use no cloud API at all, and any provider
            you connect bills its own usage directly to you.
          </p>
        </div>
      </div>
      ...
      <div className="install-panel-footer">
        <GooglePlayBadge href={PLAY_URL} target="_blank" rel="noreferrer" className="install-play-badge" />
        <p>Android 8.0+ · No subscription · Optional provider APIs charge only for what you use</p>
      </div>
